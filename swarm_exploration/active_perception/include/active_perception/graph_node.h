...
public:
  ...
  static bool straightLineFeasible(const Vector3d& p1, const Vector3d& p2);
  static bool validPathExists(const Vector3d& p1, const Vector3d& p2);
  static bool validPathExists(const Vector3d& p1, const Vector3d& p2, double& path_length);
