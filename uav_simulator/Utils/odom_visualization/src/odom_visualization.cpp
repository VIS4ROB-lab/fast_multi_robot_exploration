...
void odom_callback(const nav_msgs::Odometry::ConstPtr& msg) {
  ...
  velROS.action = visualization_msgs::Marker::MODIFY;
  velROS.pose.position = msg->pose.pose.position;
...
int main(int argc, char** argv) {
  ...
  pathPub = n.advertise<nav_msgs::Path>("path", 1, true);
  velPub = n.advertise<visualization_msgs::Marker>("velocity", 1, true);
  covPub = n.advertise<visualization_msgs::Marker>("covariance", 1, true);
  covVelPub =
      n.advertise<visualization_msgs::Marker>("covariance_velocity", 1, true);
  trajPub = n.advertise<visualization_msgs::Marker>("trajectory", 1, true);
  sensorPub = n.advertise<visualization_msgs::Marker>("sensor", 1, true);
  meshPub = n.advertise<visualization_msgs::Marker>("robot", 1, true);
  heightPub = n.advertise<sensor_msgs::Range>("height", 1, true);
