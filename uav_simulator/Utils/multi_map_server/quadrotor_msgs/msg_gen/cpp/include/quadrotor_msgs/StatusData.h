...
struct StatusData_ {
  ...
  StatusData_(const ContainerAllocator& _alloc)
      : header(_alloc), loop_rate(0), voltage(0.0), seq(0) {}
  ...
  typedef boost::shared_ptr< ::quadrotor_msgs::StatusData_<ContainerAllocator> >
      Ptr;
  typedef boost::shared_ptr<
      ::quadrotor_msgs::StatusData_<ContainerAllocator> const>
      ConstPtr;
};  // struct StatusData
...
typedef boost::shared_ptr< ::quadrotor_msgs::StatusData const>
    StatusDataConstPtr;
...
std::ostream& operator<<(
  ...
  ros::message_operations::Printer<
      ::quadrotor_msgs::StatusData_<ContainerAllocator> >::stream(s, "", v);
  return s;
}
...
struct MD5Sum< ::quadrotor_msgs::StatusData_<ContainerAllocator> > {
  ...
  static const char* value(
      const ::quadrotor_msgs::StatusData_<ContainerAllocator>&) {
    return value();
  }
...
struct HasHeader< ::quadrotor_msgs::StatusData_<ContainerAllocator> >
    : public TrueType {};
template <class ContainerAllocator>
struct HasHeader<const ::quadrotor_msgs::StatusData_<ContainerAllocator> >
    : public TrueType {};
}  // namespace message_traits
}  // namespace ros
