...
struct PPROutputData_ {
  ...
  typedef boost::shared_ptr<
      ::quadrotor_msgs::PPROutputData_<ContainerAllocator> >
      Ptr;
  typedef boost::shared_ptr<
      ::quadrotor_msgs::PPROutputData_<ContainerAllocator> const>
      ConstPtr;
...
typedef boost::shared_ptr< ::quadrotor_msgs::PPROutputData const>
    PPROutputDataConstPtr;
...
std::ostream& operator<<(
  ...
  ros::message_operations::Printer<
      ::quadrotor_msgs::PPROutputData_<ContainerAllocator> >::stream(s, "", v);
  return s;
}
...
struct MD5Sum< ::quadrotor_msgs::PPROutputData_<ContainerAllocator> > {
  ...
  static const char* value(
      const ::quadrotor_msgs::PPROutputData_<ContainerAllocator>&) {
    return value();
  }
...
struct HasHeader< ::quadrotor_msgs::PPROutputData_<ContainerAllocator> >
    : public TrueType {};
template <class ContainerAllocator>
struct HasHeader<const ::quadrotor_msgs::PPROutputData_<ContainerAllocator> >
    : public TrueType {};
}  // namespace message_traits
}  // namespace ros
