...
struct PositionCommand_ {
  ...
  typedef boost::shared_ptr<
      ::quadrotor_msgs::PositionCommand_<ContainerAllocator> >
      Ptr;
  typedef boost::shared_ptr<
      ::quadrotor_msgs::PositionCommand_<ContainerAllocator> const>
      ConstPtr;
};  // struct PositionCommand
typedef ::quadrotor_msgs::PositionCommand_<std::allocator<void> >
    PositionCommand;

typedef boost::shared_ptr< ::quadrotor_msgs::PositionCommand>
    PositionCommandPtr;
typedef boost::shared_ptr< ::quadrotor_msgs::PositionCommand const>
    PositionCommandConstPtr;
...
std::ostream& operator<<(
  ...
  ros::message_operations::Printer<
      ::quadrotor_msgs::PositionCommand_<ContainerAllocator> >::stream(s, "",
                                                                       v);
  return s;
}
...
struct MD5Sum< ::quadrotor_msgs::PositionCommand_<ContainerAllocator> > {
  ...
  static const char* value(
      const ::quadrotor_msgs::PositionCommand_<ContainerAllocator>&) {
    return value();
  }
...
struct HasHeader< ::quadrotor_msgs::PositionCommand_<ContainerAllocator> >
    : public TrueType {};
template <class ContainerAllocator>
struct HasHeader<const ::quadrotor_msgs::PositionCommand_<ContainerAllocator> >
    : public TrueType {};
}  // namespace message_traits
}  // namespace ros
...
struct Printer< ::quadrotor_msgs::PositionCommand_<ContainerAllocator> > {
  ...
  static void stream(
    ...
    s << indent << "position: ";
    s << std::endl;
    Printer< ::geometry_msgs::Point_<ContainerAllocator> >::stream(
        s, indent + "  ", v.position);
    s << indent << "velocity: ";
    s << std::endl;
