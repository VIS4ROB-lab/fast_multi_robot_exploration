...
struct AuxCommand_ {
  ...
  typedef boost::shared_ptr< ::quadrotor_msgs::AuxCommand_<ContainerAllocator> >
      Ptr;
  typedef boost::shared_ptr<
      ::quadrotor_msgs::AuxCommand_<ContainerAllocator> const>
      ConstPtr;
};  // struct AuxCommand
...
typedef boost::shared_ptr< ::quadrotor_msgs::AuxCommand const>
    AuxCommandConstPtr;
...
std::ostream& operator<<(
  ...
  ros::message_operations::Printer<
      ::quadrotor_msgs::AuxCommand_<ContainerAllocator> >::stream(s, "", v);
  return s;
}
...
struct MD5Sum< ::quadrotor_msgs::AuxCommand_<ContainerAllocator> > {
  ...
  static const char* value(
      const ::quadrotor_msgs::AuxCommand_<ContainerAllocator>&) {
    return value();
  }
