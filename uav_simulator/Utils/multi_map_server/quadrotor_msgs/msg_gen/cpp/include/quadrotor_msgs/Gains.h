...
struct Gains_ {
  ...
  Gains_(const ContainerAllocator& _alloc)
      : Kp(0.0), Kd(0.0), Kp_yaw(0.0), Kd_yaw(0.0) {}
  ...
  typedef boost::shared_ptr< ::quadrotor_msgs::Gains_<ContainerAllocator> const>
      ConstPtr;
};  // struct Gains
...
std::ostream& operator<<(
    std::ostream& s, const ::quadrotor_msgs::Gains_<ContainerAllocator>& v) {
  ros::message_operations::Printer<
      ::quadrotor_msgs::Gains_<ContainerAllocator> >::stream(s, "", v);
  return s;
}
...
struct MD5Sum< ::quadrotor_msgs::Gains_<ContainerAllocator> > {
  ...
  static const char* value(
      const ::quadrotor_msgs::Gains_<ContainerAllocator>&) {
    return value();
  }
