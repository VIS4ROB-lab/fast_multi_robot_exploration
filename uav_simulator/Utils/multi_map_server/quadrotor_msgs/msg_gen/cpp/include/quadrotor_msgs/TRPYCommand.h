...
struct TRPYCommand_ {
  ...
  TRPYCommand_()
      : header(), thrust(0.0), roll(0.0), pitch(0.0), yaw(0.0), aux() {}
  ...
  typedef boost::shared_ptr<
      ::quadrotor_msgs::TRPYCommand_<ContainerAllocator> >
      Ptr;
  typedef boost::shared_ptr<
      ::quadrotor_msgs::TRPYCommand_<ContainerAllocator> const>
      ConstPtr;
};  // struct TRPYCommand
...
typedef boost::shared_ptr< ::quadrotor_msgs::TRPYCommand const>
    TRPYCommandConstPtr;
...
std::ostream& operator<<(
  ...
  ros::message_operations::Printer<
      ::quadrotor_msgs::TRPYCommand_<ContainerAllocator> >::stream(s, "", v);
  return s;
}
...
struct MD5Sum< ::quadrotor_msgs::TRPYCommand_<ContainerAllocator> > {
  ...
  static const char* value(
      const ::quadrotor_msgs::TRPYCommand_<ContainerAllocator>&) {
    return value();
  }
...
struct HasHeader< ::quadrotor_msgs::TRPYCommand_<ContainerAllocator> >
    : public TrueType {};
template <class ContainerAllocator>
struct HasHeader<const ::quadrotor_msgs::TRPYCommand_<ContainerAllocator> >
    : public TrueType {};
}  // namespace message_traits
}  // namespace ros
