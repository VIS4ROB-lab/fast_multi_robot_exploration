...
struct Corrections_ {
  ...
  Corrections_(const ContainerAllocator& _alloc)
      : kf_correction(0.0), angle_corrections() {
    angle_corrections.assign(0.0);
  }
  ...
  typedef boost::shared_ptr<
      ::quadrotor_msgs::Corrections_<ContainerAllocator> >
      Ptr;
  typedef boost::shared_ptr<
      ::quadrotor_msgs::Corrections_<ContainerAllocator> const>
      ConstPtr;
};  // struct Corrections
...
typedef boost::shared_ptr< ::quadrotor_msgs::Corrections const>
    CorrectionsConstPtr;
...
std::ostream& operator<<(
  ...
  ros::message_operations::Printer<
      ::quadrotor_msgs::Corrections_<ContainerAllocator> >::stream(s, "", v);
  return s;
}
...
struct MD5Sum< ::quadrotor_msgs::Corrections_<ContainerAllocator> > {
  ...
  static const char* value(
      const ::quadrotor_msgs::Corrections_<ContainerAllocator>&) {
    return value();
  }
