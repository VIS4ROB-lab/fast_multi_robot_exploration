...
struct OutputData_ {
  ...
  typedef ::geometry_msgs::Vector3_<ContainerAllocator>
  ...
  typedef boost::shared_ptr< ::quadrotor_msgs::OutputData_<ContainerAllocator> >
      Ptr;
  typedef boost::shared_ptr<
      ::quadrotor_msgs::OutputData_<ContainerAllocator> const>
      ConstPtr;
};  // struct OutputData
...
typedef boost::shared_ptr< ::quadrotor_msgs::OutputData const>
    OutputDataConstPtr;
...
std::ostream& operator<<(
  ...
  ros::message_operations::Printer<
      ::quadrotor_msgs::OutputData_<ContainerAllocator> >::stream(s, "", v);
  return s;
}
...
struct MD5Sum< ::quadrotor_msgs::OutputData_<ContainerAllocator> > {
  ...
  static const char* value(
      const ::quadrotor_msgs::OutputData_<ContainerAllocator>&) {
    return value();
  }
...
struct HasHeader< ::quadrotor_msgs::OutputData_<ContainerAllocator> >
    : public TrueType {};
template <class ContainerAllocator>
struct HasHeader<const ::quadrotor_msgs::OutputData_<ContainerAllocator> >
    : public TrueType {};
}  // namespace message_traits
}  // namespace ros
...
struct Printer< ::quadrotor_msgs::OutputData_<ContainerAllocator> > {
  ...
  static void stream(
    ...
    Printer< ::geometry_msgs::Vector3_<ContainerAllocator> >::stream(
        s, indent + "  ", v.angular_velocity);
    s << indent << "linear_acceleration: ";
    s << std::endl;
    Printer< ::geometry_msgs::Vector3_<ContainerAllocator> >::stream(
        s, indent + "  ", v.linear_acceleration);
