...
struct VerticalOccupancyGridList_ {
  ...
  typedef std::vector<
      int32_t, typename ContainerAllocator::template rebind<int32_t>::other>
      _upper_type;
  std::vector<int32_t,
              typename ContainerAllocator::template rebind<int32_t>::other>
      upper;
  ...
  typedef boost::shared_ptr<
      ...
      Ptr;
  typedef boost::shared_ptr<
      ::multi_map_server::VerticalOccupancyGridList_<ContainerAllocator> const>
      ConstPtr;
};  // struct VerticalOccupancyGridList
typedef ::multi_map_server::VerticalOccupancyGridList_<std::allocator<void> >
    VerticalOccupancyGridList;

typedef boost::shared_ptr< ::multi_map_server::VerticalOccupancyGridList>
    VerticalOccupancyGridListPtr;
...
std::ostream& operator<<(
    std::ostream& s,
    const ::multi_map_server::VerticalOccupancyGridList_<ContainerAllocator>&
        v) {
...
struct MD5Sum<
  ...
  static const char* value(const ::multi_map_server::VerticalOccupancyGridList_<
                           ContainerAllocator>&) {
    return value();
  }
