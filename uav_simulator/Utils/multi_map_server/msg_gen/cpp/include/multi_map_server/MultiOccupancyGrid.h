...
struct MultiOccupancyGrid_ {
  ...
  typedef boost::shared_ptr<
      ::multi_map_server::MultiOccupancyGrid_<ContainerAllocator> >
      Ptr;
  typedef boost::shared_ptr<
      ::multi_map_server::MultiOccupancyGrid_<ContainerAllocator> const>
      ConstPtr;
};  // struct MultiOccupancyGrid
typedef ::multi_map_server::MultiOccupancyGrid_<std::allocator<void> >
    MultiOccupancyGrid;

typedef boost::shared_ptr< ::multi_map_server::MultiOccupancyGrid>
    MultiOccupancyGridPtr;
typedef boost::shared_ptr< ::multi_map_server::MultiOccupancyGrid const>
    MultiOccupancyGridConstPtr;
...
std::ostream& operator<<(
  ...
  ros::message_operations::Printer<
      ::multi_map_server::MultiOccupancyGrid_<ContainerAllocator> >::stream(s,
                                                                            "",
                                                                            v);
  return s;
}
...
struct MD5Sum< ::multi_map_server::MultiOccupancyGrid_<ContainerAllocator> > {
  ...
  static const char* value(
      const ::multi_map_server::MultiOccupancyGrid_<ContainerAllocator>&) {
    return value();
  }
...
struct Printer< ::multi_map_server::MultiOccupancyGrid_<ContainerAllocator> > {
  ...
  static void stream(
    ...
    for (size_t i = 0; i < v.maps.size(); ++i) {
      ...
      s << std::endl;
      s << indent;
      Printer< ::nav_msgs::OccupancyGrid_<ContainerAllocator> >::stream(
          s, indent + "    ", v.maps[i]);
    }
