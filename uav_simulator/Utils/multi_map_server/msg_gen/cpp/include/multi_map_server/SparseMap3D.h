...
struct SparseMap3D_ {
  ...
  SparseMap3D_(const ContainerAllocator& _alloc)
      : header(_alloc), info(_alloc), lists(_alloc) {}
  ...
  typedef std::vector<
      ::multi_map_server::VerticalOccupancyGridList_<ContainerAllocator>,
  ...
  typedef boost::shared_ptr<
      ...
      Ptr;
  typedef boost::shared_ptr<
      ::multi_map_server::SparseMap3D_<ContainerAllocator> const>
      ConstPtr;
};  // struct SparseMap3D
...
typedef boost::shared_ptr< ::multi_map_server::SparseMap3D const>
    SparseMap3DConstPtr;
...
std::ostream& operator<<(
  ...
  ros::message_operations::Printer<
      ::multi_map_server::SparseMap3D_<ContainerAllocator> >::stream(s, "", v);
  return s;
}
...
struct MD5Sum< ::multi_map_server::SparseMap3D_<ContainerAllocator> > {
  ...
  static const char* value(
      const ::multi_map_server::SparseMap3D_<ContainerAllocator>&) {
    return value();
  }
...
struct HasHeader< ::multi_map_server::SparseMap3D_<ContainerAllocator> >
    : public TrueType {};
template <class ContainerAllocator>
struct HasHeader<const ::multi_map_server::SparseMap3D_<ContainerAllocator> >
    : public TrueType {};
}  // namespace message_traits
}  // namespace ros
...
struct Printer< ::multi_map_server::SparseMap3D_<ContainerAllocator> > {
  ...
  static void stream(
    ...
    s << indent << "info: ";
    s << std::endl;
    Printer< ::nav_msgs::MapMetaData_<ContainerAllocator> >::stream(
        s, indent + "  ", v.info);
    ...
    for (size_t i = 0; i < v.lists.size(); ++i) {
      ...
      s << std::endl;
      s << indent;
      Printer< ::multi_map_server::VerticalOccupancyGridList_<
          ContainerAllocator> >::stream(s, indent + "    ", v.lists[i]);
    }
  }
};
