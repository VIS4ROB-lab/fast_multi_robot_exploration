...
struct MultiSparseMap3D_ {
  ...
  MultiSparseMap3D_(const ContainerAllocator& _alloc)
      : maps(_alloc), origins(_alloc) {}

  typedef std::vector<
      ::multi_map_server::SparseMap3D_<ContainerAllocator>,
  ...
  typedef std::vector< ::geometry_msgs::Pose_<ContainerAllocator>,
                       typename ContainerAllocator::template rebind<
                           ::geometry_msgs::Pose_<ContainerAllocator> >::other>
      _origins_type;
  ...
  typedef boost::shared_ptr<
      ::multi_map_server::MultiSparseMap3D_<ContainerAllocator> >
      Ptr;
  typedef boost::shared_ptr<
      ::multi_map_server::MultiSparseMap3D_<ContainerAllocator> const>
      ConstPtr;
};  // struct MultiSparseMap3D
typedef ::multi_map_server::MultiSparseMap3D_<std::allocator<void> >
    MultiSparseMap3D;

typedef boost::shared_ptr< ::multi_map_server::MultiSparseMap3D>
    MultiSparseMap3DPtr;
typedef boost::shared_ptr< ::multi_map_server::MultiSparseMap3D const>
    MultiSparseMap3DConstPtr;
...
std::ostream& operator<<(
  ...
  ros::message_operations::Printer<
      ::multi_map_server::MultiSparseMap3D_<ContainerAllocator> >::stream(s, "",
                                                                          v);
  return s;
}
...
struct MD5Sum< ::multi_map_server::MultiSparseMap3D_<ContainerAllocator> > {
  ...
  static const char* value(
      const ::multi_map_server::MultiSparseMap3D_<ContainerAllocator>&) {
    return value();
  }
...
struct Printer< ::multi_map_server::MultiSparseMap3D_<ContainerAllocator> > {
  ...
  static void stream(
    ...
    for (size_t i = 0; i < v.maps.size(); ++i) {
      ...
      s << std::endl;
      s << indent;
      Printer< ::multi_map_server::SparseMap3D_<ContainerAllocator> >::stream(
          s, indent + "    ", v.maps[i]);
    }
